                ...
                <div style={{width:"95%", margin:"auto"}}>
                    <div className="d-flex justify-content-around pt-1">
                        {this.alphabet1.map((letter) => {
                            return <div key={"keyboard-" + letter} onClick={() => { this.disable(letter) }} className={this.state.letterEnabled.indexOf(letter) == -1 ? "click-item d-flex justify-content-center unselect" : "disabled d-flex justify-content-center unselect"}>{letter}</div>
                        })}
                    </div>
