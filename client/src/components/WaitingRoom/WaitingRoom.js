    ...
    return (
      <div className="container">
        <div>
          ...
          >
            <SingleButton
              color={this.localReady ? "#1eba57" : "#ba1e68"}
              func={this.toggleReady}
              text={this.localReady ? "Ready" : "Join Game"}
            />
          </div>
          <PlayerSection gameData={gameData} />
          {this.redirectPath !== "" ? (
            <Redirect to={{ pathname: this.redirectPath }} />
          ) : (
            ""
          )}
          {this.redirectPath2 !== "" ? (
            <Redirect to={{ pathname: this.redirectPath2 }} />
          ) : (
            ""
          )}
        </div>
