        ...
        return (
            <div>
                <nav className="row d-flex" style={{ backgroundColor: "#1D1135", Width:"100%", color: "white", height: "70px"}}>
                    <span className="d-flex flex-grow-1 p-2"><span><Link to="/" className="nav-link"><img alt="pointer" style={{ cursor: "pointer", position: "absolute", top: "-32px", left: "30px" }} src={logo} height="145px" width="155px"></img></Link></span></span>
