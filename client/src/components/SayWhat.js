...
class SayWhat extends Component {
  constructor(props) {
    ...
    this.state = {
      players: [],
      histScore: props.user.histScore
    };
  }
  ...
  isKeyboardOnScreen = () => {
    if (this.myturn) {
      if (
        this.gameData.gameState === "Selecting Consonant" ||
        this.gameData.gameState === "Buy Vowel"
      ) {
        return true;
      }
      return false;
          ...
          <div className="container" style={{ maxWidth: "98%" }}>
            <div
              style={{
                ...
                width: "97%",
                height: "600px",
                zIndex: this.isPuzzleSolveOnScreen() ? 1 : -1,
                overflow: "hidden"
              }}
            >
              <div
                className={
                  this.isPuzzleSolveOnScreen()
                    ? "puzzleSolveOffScreen puzzleSolveOnScreen"
                    : "puzzleSolveOffScreen"
                }
              >
                <PuzzleSolve
            ...
            <div className="row h-100">
              <div className="col-6 left" style={{ overflow: "hidden" }}>
                ...
                <div style={{ position: "relative" }}>
                  <div
                    className={
                      this.isKeyboardOnScreen()
                        ? "keyboardOffScreen keyboardOnScreen"
                        : "keyboardOffScreen"
                    }
                  >
                    <VirtualKeyboard
